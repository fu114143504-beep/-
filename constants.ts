...
export const STORIES: Story[] = [
  ...
  { id: 's2', title: { en: 'II. Gold and Jade', vn: 'II. Kim Ngọc lương duyên', jp: 'II. 金玉の縁', kr: 'II. 금옥의 인연', 'zh-tw': '二、金玉良緣：薛寶釵的到來', 'zh-cn': '二、金玉良缘：薛宝钗の到来' }, content: { en: 'Xue Baochai arrives with a golden locket. People say it matches Baoyu\'s jade. This puts pressure on Daiyu.', vn: 'Tiết Bảo Thoa đến với chiếc khóa vàng, tạo nên lời đồn về "Kim Ngọc lương duyên". Điều này gây áp lực cho Đại Ngọc.', jp: '寶釵が金の首飾りを持って現れ、寶玉の玉との縁が噂されます。これが黛玉の壓力になります。', kr: '보차가 금노리개를 가지고 오자 소문이 돕니다. 대옥에게는 압박이 됩니다.', 'zh-tw': '端莊大方的薛寶釵帶著金鎖來到賈府，眾人傳言「金鎖要配有玉的」，這給了敏感的黛玉巨大的壓力。', 'zh-cn': '端庄大方的薛宝钗带着金锁来到贾府，众人传言「金锁要配有玉的」，这给了敏感的黛玉巨大的压力。' }, culturalLesson: { en: 'Collective harmony vs individual romance.', vn: 'Hòa hợp tập thể và lãng mạn cá nhân.', jp: '集団の調和。', kr: '집단의 조화.', 'zh-tw': '傳統社會中，家族的利益往往高於個人的情感追求。', 'zh-cn': '传统社会中，家族的利益往往高于个人的情感追求。' } },
...
export const DAILY_PHRASES: PhraseEntry[] = [
  { id: 'd1', phrase: '改天再約吧', literal: { en: 'Another day.', vn: 'Hôm khác nhé.', jp: 'また今度。', kr: '다음에 봐요.', 'zh-tw': '換個時間再見。', 'zh-cn': '换个時間再見。' }, hidden: { en: 'Polite "No".', vn: 'Từ chối lịch sự.', jp: '丁寧な拒絶。', kr: '정중한 거절.', 'zh-tw': '意思就是：我現在不想去。', 'zh-cn': '意思就是：我现在不想去。' }, example: 'A: 明天去玩嗎？ B: 改天再約吧。' },
