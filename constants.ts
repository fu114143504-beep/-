...
export const NAV_LABELS: Record<string, MultiLangText> = {
  ...
  analyzer: { en: 'Analyzer', vn: 'Phân tích', jp: '分析器', kr: '분석기', 'zh-tw': '分析器', 'zh-cn': '分析器' },
  'ai-tutor': { en: 'Tutor', vn: 'Gia sư', jp: '講師', kr: '교사', 'zh-tw': '導師', 'zh-cn': '導師' }
};
...
export const HOME_CONTENT = {
  ...
  tipDesc: { en: 'Explore different modules in the sidebar. Switch languages anytime to compare.', vn: 'Khám phá các mô-đun ở thanh bên. Đổi ngôn ngữ bất cứ lúc nào để so sánh.', jp: 'サイドバーの各モジュールを探索してください。いつでも言語を切り替えて比較できます。', kr: '사이드바의 다양한 모듈을 탐색하세요. 언제든 언어를 전환하여 비교할 수 있습니다.', 'zh-tw': '利用側邊欄探索不同模組，您可以隨時切換語言來對比解釋。', 'zh-cn': '利用侧边栏探索不同模组，您可以随时切换语言来对比解释。' },
...
export const STORIES: Story[] = [
  ...
  { 
    id: 's2', 
    title: { en: 'II. Gold and Jade', vn: 'II. Kim Ngọc lương duyên', jp: 'II. 金玉の縁', kr: 'II. 금옥의 인연', 'zh-tw': '二、金玉良緣：薛寶釵的到來', 'zh-cn': '二、金玉良缘：薛宝钗的到来' }, 
    content: { 
      ...
      vn: 'Tiết Bảo Thoa đến với chiếc khóa vàng, tạo nên lời đồn về "Kim Ngọc lương duyên". Điều này tượng trưng cho sự phù hợp xã hội so với mối quan hệ tâm linh của Đại Ngọc.', 
  ...
  { 
    ...
    content: { 
      ...
      vn: 'Đại Ngọc chôn cánh hoa tàn, dự đoán cái chết của chính mình. Sự nhạy cảm của cô xung đột với thế giới lạnh lẽo.', 
      ...
      'zh-cn': '看着残花落尽，黛玉筑冢埋花，吟诵出凄婉的《葬花吟》。她将自己比作残花，预见了自己的悲剧性结局。在大宅门的冷酷现实中，她那颗纯净的灵魂无处安放，是对这个世界真情的无声控诉。' 
    }, 
    culturalLesson: { 
  ...
  { 
    id: 's5', 
    title: { en: 'V. The Dream Ends', vn: 'V. Mộng tàn', jp: 'V. 夢の終わり', kr: 'V. 꿈의 끝', 'zh-tw': '五、夢醒時分：賈府的沒落與歸宿', 'zh-cn': '五、梦醒时分：贾府的没落与归宿' }, 
    content: { 
...
export const CRISES: CrisisDilemma[] = [
  ...
  {
    id: 'c2',
    topic: { en: 'Scenario 2: Nicknames and Power', vn: 'Kịch bản 2: Biệt danh và Quyền lực', jp: 'シナリオ2：愛称と権力', kr: '시나리오 2: 별명과 권력', 'zh-tw': '情境二：介紹詞與權力關係', 'zh-cn': '情境二：介绍词与权力关系' },
    ...
    crisisExplanation: { en: 'This signifies trust and favor.', vn: 'Điều này thể hiện sự tin tưởng và ưu ái.', jp: 'これは信頼の証です。', kr: '이는 신뢰의 표시입니다.', 'zh-tw': '這展現了極高的親密感。', 'zh-cn': '这展现了极高的亲密感。' },
    ...
    discussionQuestion: { en: 'Can you use slang with elders?', vn: 'Có thể dùng từ lóng với người lớn?', jp: '長老に俗語を使える？', kr: '어른에게 속어를 써도 될까?', 'zh-tw': '你覺得對長輩開玩笑合適嗎？', 'zh-cn': '你觉得对长辈开玩笑合适吗？' }
  },
  {
    id: 'c3',
  ...
  },
  {
    ...
    theoryName: { en: 'Group Loyalty', vn: 'Lòng trung thành với nhóm', jp: 'グループの忠誠心', kr: '집단 충성심', 'zh-tw': '集體主義', 'zh-cn': '集体主义' },
...
export const PROVERBS: PhraseEntry[] = [
  ...
  { id: 'p6', phrase: '冤家宜解不宜結', literal: { en: 'Friends not foes.', vn: 'Thêm bạn bớt thù.', jp: '和解。', kr: '화해.', 'zh-tw': '化解矛盾。', 'zh-cn': '化解矛盾。' }, hidden: { en: 'Harmony.', vn: 'Hòa hợp.', jp: '調和。', kr: '조화.', 'zh-tw': '不樹敵。', 'zh-cn': '不树敌。' }, example: '冤家宜解。' },
...
export const DAILY_PHRASES: PhraseEntry[] = [
  ...
  { id: 'd10', phrase: '你看著辦吧', literal: { en: 'Do as you see fit.', vn: 'Tùy bạn.', jp: '任せる。', kr: '알아서 해.', 'zh-tw': '情緒話。', 'zh-cn': '情绪话。' }, hidden: { en: 'Annoyed.', vn: 'Khó chịu.', jp: '不快。', kr: '짜증.', 'zh-tw': '我生氣了。', 'zh-cn': '我生气了。' }, example: '看著辦。' },
  ...
  { id: 'd23', phrase: '有機會再說', literal: { en: 'Chance later.', vn: 'Cơ hội sau.', jp: '機会があれば。', kr: '기회가 되면.', 'zh-tw': '渺茫。', 'zh-cn': '渺茫。' }, hidden: { en: 'Never.', vn: 'Không bao giờ.', jp: '絶対ない。', kr: '절대 없어.', 'zh-tw': '再也不。', 'zh-cn': '再也不。' }, example: '有機會。' },
  { id: 'd24', phrase: '我是為你好', literal: { en: 'For your good.', vn: 'Vì tốt cho bạn.', jp: 'あなたのため。', kr: '너를 위해서야.', 'zh-tw': '情緒勒索。', 'zh-cn': '情绪勒索。' }, hidden: { en: 'Control.', vn: 'Kiểm soát.', jp: '支配。', kr: '지배.', 'zh-tw': '強迫接受。', 'zh-cn': '强迫接受。' }, example: '為你好。' },
